...
init_harness() {
  ...
  HARNESS_NEXT_CMD="${HARNESS_NEXT_CMD:-dinit auth}"
  HARNESS_GITHUB_HTTPS_REMOTE="${HARNESS_GITHUB_HTTPS_REMOTE:-https://github.com/example/acme.git}"
  ...
  export HARNESS_REDACT_TOKEN HARNESS_REDACT_GLPAT HARNESS_NEXT_CMD
  export HARNESS_GITHUB_HTTPS_REMOTE HARNESS_EXPECTED_VERSION
}
